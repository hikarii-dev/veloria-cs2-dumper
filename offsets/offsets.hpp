...
namespace offsets {
    ...
    namespace client {
        ...
        constexpr std::ptrdiff_t LocalController = 0x2383DB0;
        constexpr std::ptrdiff_t GlobalEntityList = 0x21D5FE0;
        constexpr std::ptrdiff_t ViewMatrix = 0x23AE550;
        constexpr std::ptrdiff_t dwCSGOInput = 0x2318E20;
    ...
    // engine2.dll
    namespace engine2 {
        constexpr std::ptrdiff_t BuildInfo = 0x918D90;
        constexpr std::ptrdiff_t NetworkGameClientInstance = 0x90D490;
